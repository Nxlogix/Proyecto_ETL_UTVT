-- =============================================
-- CREACIÓN DE BASE DE DATOS DWUTVTVentas
-- =============================================
...
CREATE TABLE FactVentas (
    ...
    CONSTRAINT FK_FactVentas_DimCliente FOREIGN KEY (IdClienteSK) 
        REFERENCES DimCliente(IdClienteSK),
    CONSTRAINT FK_FactVentas_DimProducto FOREIGN KEY (IdProductoSK) 
        REFERENCES DimProducto(IdProductoSK),
    CONSTRAINT UQ_FactVentas_IdVentaOrigen UNIQUE (IdVentaOrigen)
);
GO
